      ...
      {label ? (
        <div className={className}>
          ...
          <div className="relative">
            ...
            <label
              htmlFor={name}
              className={`absolute left-4 top-1 z-10 origin-[0] -translate-y-4 scale-75 transform cursor-text select-none bg-white px-1 text-sm font-medium text-black/40 duration-300 peer-placeholder-shown:top-1/2 peer-placeholder-shown:-translate-y-1/2 peer-placeholder-shown:scale-100 peer-focus:top-1 peer-focus:-translate-y-4 peer-focus:scale-75 peer-focus:cursor-default peer-focus:px-2 peer-focus:text-base peer-focus:text-gray-600 ${
                error ? 'text-red-400' : ''
              }`}
            >
              {label}
